...
class Pyqt5_Serial(QtWidgets.QWidget, Ui_Form):
    ...
    def data_receive(self):
        ...
        if num > 0:
            ...
            for i in range(0, len(data)):
                ...
                # self.wrtnodeGateway.ReceiveFiniteStates(data[i])
    ...
    def plotData(self):
        # self.pha += 10
        # self.curve1.setData(y=np.random.normal(size=100))
        self.curve1.setData(self.stateMachine.EcgDataList)
        ...
        if self.receive_state == self.SyncHeader1:
            ...
            if self.DataLength == 1 or self.DataLength == 3:
                ...
                if self.DataCategory == 1:
                    ...
                    print(self.data)
                    if len(self.EcgDataList) == 2000:
                        self.EcgDataList.clear()
